...
async function initSchema() {
  await db.exec(`
    CREATE TABLE IF NOT EXISTS users (
      ...
      phone         TEXT,
      role          TEXT NOT NULL DEFAULT 'owner', -- owner | admin | developer | auditor
      org_id        INTEGER REFERENCES users(id),  -- team owner's user id; a fresh owner points at themself
  ...
  // Migration path for DBs created before role/org_id existed.
  ...
  await db.exec(`
    CREATE TABLE IF NOT EXISTS servers (
      id            SERIAL PRIMARY KEY,
      user_id       INTEGER NOT NULL REFERENCES users(id), -- who launched it
      org_id        INTEGER NOT NULL REFERENCES users(id), -- team it belongs to (shared visibility)
      name          TEXT NOT NULL,
      os            TEXT NOT NULL,
      size          TEXT NOT NULL,
  ...
  await db.exec(`
    CREATE TABLE IF NOT EXISTS invoices (
      ...
      org_id          INTEGER NOT NULL REFERENCES users(id),
